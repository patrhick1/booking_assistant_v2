...
class SlackFeedbackService:
    ...
    def __init__(self):
        ...
        self.app_url = os.getenv("APP_URL", "http://localhost:8080")  # Application URL
        ...
        blocks.extend([
            ...
            },
            {
                ...
                "elements": [
                    {
                        "type": "mrkdwn",
                        "text": f"🤖 Generated by BookingAssistant • Session: {session_id[:8]}... • <{self.app_url}|View Dashboard>"
                    }
                ]
            }
        ])
                ...
                self.slack_client.chat_postEphemeral(
                    ...
                    },
                    {
                        ...
                        "elements": [{
                            ...
                            "url": f"{self.app_url}/session/{session_id}",
